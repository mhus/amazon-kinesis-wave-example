...
public class WavProcessor {
    ...
    private static final Log LOG = LogFactory.getLog(WavProcessor.class);
    ...
    private static void checkUsage(String[] args) {
        if (args.length != 3) {
            System.err.println("Usage: " + WavProcessor.class.getSimpleName()
    ...
    public static void main(String[] args) throws Exception {
        ...
        WavRecordProcessorFactory shardRecordProcessor = new WavRecordProcessorFactory();
